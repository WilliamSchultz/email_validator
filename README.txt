...
2. domain name is not shorter than 3 characters and no longer than 256, is a set of non-empty strings of characters az 0-9_-and delimited;
...
5. in the name are not allowed two points in a row;
